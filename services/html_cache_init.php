...
define('ROOT_PATH', str_replace('services/html_cache_init.php', '', str_replace('\\', '/', __FILE__)));
define('TMPL_PATH', 'app/Tpl/');
define('TIME',a_gmtTime());
...
//	$unit = $GLOBALS['db']->getOne("select val from ".DB_PREFIX."sys_conf where name = 'BASE_CURRENCY_UNIT'");
	$unit = eyooC2("BASE_CURRENCY_UNIT");
...
{
	return eyooC2("BASE_CURRENCY_UNIT").round($price,2);
