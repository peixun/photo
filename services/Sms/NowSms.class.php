...
include_once(ROOT_PATH."ThinkPHP/Vendor/Sms/Now/now.inc.php");

// 时代互联企业短信平台

class NowSms implements Sms 
{
	public $config = array(
		"port"=>0,
		"apitype"=>0
