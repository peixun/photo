...
function delConst(id){
 if( confirm("是否删除预约工地") ){
  $.post( '__APP__/Member/delbookDesigner',{id:id},function(text ){
      if( text == 1 ){
    	  alert("删除成功！");
...
<div class="container">
	<div class="info_lf">
		...
		<div class="info_c">
            ...
            <p class="clk"  ><a href="__APP__/Member/bookDesigner">已预约设计师</a></p>
	...
	<div class="info_rt">
		<div class="info_rtit">
			<div class="inrt_n">已预约设计师</div>
			<div class="inrt_r">首页&nbsp;&nbsp; &gt; <a href="__APP__/Member">个人中心</a> &gt; <a href="javascript:void(0);">已预约设计师</a></div>
		</div>
		...
		<div class="info_cont" style="min-height:300px;">
			<table border="0" cellpadding="0" cellspacing="0" class="info_tab" width="100%">
				<tr>
					<td class="tit">设计师名称</td>                                                            
					<td class="tit">设计案例名称</td>
					<td class="tit">所在公司</td>
                ...
                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): ++$i;$mod = ($i % 2 )?><tr>
					<td class=""><?php echo (getDesinger($vo["designer_id"])); ?></td>                                                                                                                          
					<td class=""><?php echo (getCaseName($vo["case_id"])); ?></td>
					<td class=""><?php echo (getHomeCompanys($vo["com_uid"])); ?></td>
