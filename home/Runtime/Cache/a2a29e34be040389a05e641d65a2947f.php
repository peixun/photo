...
<div class="container">
	<div class="info_lf">
		...
		<div class="info_c">
			...
			<p class="clk"><a href="__APP__/Company/designer">设计师管理</a></p>	
	...
	<div class="info_rt">
		<div class="info_rtit">
			<div class="inrt_n">设计师管理</div>
			<div class="inrt_r">首页&nbsp;&nbsp; &gt; <a href="javascript:void(0);">个人中心</a> &gt; <a href="javascript:void(0);" >设计师管理</a></div>
		</div>
		<div class="info_msg"><span class="i_msg2" style="float:right; width:65px;"> <a href="__APP__/Company/addDesigner">添加设计师</a></span><span class="i_msg1"><b>设计师列表</b></span></div>
		<div class="info_cont" style="min-height:300px;">
			<table border="0" cellpadding="0" cellspacing="0" class="info_tab" width="100%">
				<tr>
					<td class="tit">序号</td>                                                            
					<td class="tit">名称</td>
                    <td class="tit">擅长风格</td>
					<td class="tit">擅长项目</td>		
                    <td class="tit">擅长户型</td>	
                    <td class="tit">设计费</td>
                   
					<td class="tit">操作</td>
				</tr>
                <?php if(is_array($designer)): $i = 0; $__LIST__ = $designer;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): ++$i;$mod = ($i % 2 )?><tr>
					                                                                
					<td class=""><?php echo ($vo["id"]); ?></td>
					<td class="" style="text-align:left;">&nbsp;&nbsp;<?php echo ($vo["name_1"]); ?></td>
					<td class="" ><?php echo ($vo["good_style"]); ?></td>
					<td class=""><?php echo ($vo["good_project"]); ?></td>	
                    <td class=""><?php echo ($vo["good_unit"]); ?></td>	
                    <td class=""><?php echo ($vo["cost"]); ?></td>	
                    
					<td class=""><a href="__APP__/Company/editDesigner/id/<?php echo ($vo["id"]); ?>">修改</a> <a href="__APP__/Company/delDesigner/id/<?php echo ($vo["id"]); ?>">删除</a></td>
