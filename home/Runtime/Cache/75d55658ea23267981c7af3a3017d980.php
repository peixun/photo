...
<div class="container">
	...
	<div class="al_lf">
		<h2><?php echo ($compay["company_name"]); ?></h2>
		<div class="al_lfcont">
			...
			<div class="al_lf_c">
				<div class="qy_lc">
					<h6>
						<b>现在预约装修设计商家，立即赠送：</b><br />
						<strong>免费监理</strong>--专业工程监理保障施工质量；<strong> 资金监管</strong>--商城免费提供资金监管； <strong>先行赔付</strong>--如遇纠纷，商城保障先行赔付；
					</h6>					
					<div class="qy_picm"><img src="__PUBLIC__/images/qy_pic.jpg" /></div>
					<div><img src="__PUBLIC__/images/qyzl.jpg" /></div>
					<div class="qyzl_c">
						<p>服务区域：<?php echo ($compay["service_area"]); ?></p>
						<p>业务范围：<?php echo ($compay["business_scope"]); ?></p>
						<p>装修模式：<?php echo ($compay["decoration_pattern"]); ?></p>
						
					</div>
					<div><img src="__PUBLIC__/images/xszl.jpg" /></div>
					<div class="qyzl_c"><div class="qy_det"> <?php echo ($compay["desc"]); ?></div></div>
				</div>
			</div>
