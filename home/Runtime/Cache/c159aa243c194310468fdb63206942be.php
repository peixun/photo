...
<div class="container">
	<div class="info_lf">
		...
		<div class="info_c">
            ...
            <p ><a href="__APP__/Company/reservation">预约工地</a></p> <p><a href="__APP__/Company/book">预约管理</a></p>
            <p class="clk"><a href="__APP__/Company/watchlist">收藏管理</a></p> 
	...
	<div class="info_rt">
		<div class="info_rtit">
			<div class="inrt_n">收藏管理</div>
			<div class="inrt_r">首页&nbsp;&nbsp; &gt; <a href="javascript:void(0);">个人中心</a> &gt; <a href="javascript:void(0);" >收藏管理</a></div>
		</div>
		<div class="info_msg"><span class="i_msg2" style="float:right; width:100px;"> </span><span class="i_msg1"><b>在线收藏列表</b></span></div>
		<div class="info_cont" style="min-height:300px;">
			<table border="0" cellpadding="0" cellspacing="0" class="info_tab" width="100%">
				<tr>
                	<td class="tit">序号</td>
					<td class="tit">收藏名称</td>                                                       
					<td class="tit">收藏类型</td>
                    <td class="tit">收藏用户</td>
					<td class="tit">收藏时间</td>			
					<td class="tit">操作</td>
				</tr>
                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): ++$i;$mod = ($i % 2 )?><tr id="book_<?php echo ($vo["id"]); ?>">
					...
					<td class=""><?php echo (getAttentionName($vo["fid"],$vo['model'])); ?></td>
					<td class="" style="text-align:left;">&nbsp;&nbsp;<?php echo (getAttentionType($vo["model"])); ?></td>
					<td class="" >&nbsp;&nbsp;<?php echo (getRUserName($vo["uid"])); ?></td>
					<td class=""><?php echo (toDate($vo["create_time"],"Y-m-d")); ?> </td>			
					<td class="">
                    	<a href="javascript:void(0);" onclick="delAttention(<?php echo ($vo["id"]); ?>)">删除</a>
                    </td>
