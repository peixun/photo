...
<div class="container">
	<div class="info_lf">
		...
		<div class="info_c">
            ...
            <p><a href="__APP__/Company/construction">在建工地</a></p> <p><a href="__APP__/Company/reservation">预约工地</a></p> <p><a href="__APP__/Company/book">预约管理</a></p><p><a href="__APP__/Company/watchlist">收藏管理</a></p>  		
             <p class="clk"><a href="__APP__/Company/certificate">证书管理</a></p> 
            <p><a href="__APP__/Company/service">服务承诺</a></p> 
            <p><a href="__APP__/Company/contact">联系方式</a></p>					
	...
	<div class="info_rt">
		<div class="info_rtit">
			<div class="inrt_n">证书管理</div>
			<div class="inrt_r">首页&nbsp;&nbsp; &gt; <a href="javascript:void(0);">个人中心</a> &gt; <a href="javascript:void(0);" >证书管理</a></div>
		</div>
		<div class="info_msg"><span class="i_msg2" style="float:right; width:65px;"> <a href="__APP__/Company/addCertificate">添加证书</a></span><span class="i_msg1"><b>证书列表</b></span></div>
		<div class="info_cont" style="min-height:300px;">
			<table border="0" cellpadding="0" cellspacing="0" class="info_tab" width="100%">
				<tr>
					<td class="tit">序号</td>                                                            
					<td class="tit">证书名称</td>
                    <td class="tit">证书图片</td>
					<td class="tit">发布时间</td>			
					<td class="tit">操作</td>
				</tr>
                <?php if(is_array($certificate)): $i = 0; $__LIST__ = $certificate;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): ++$i;$mod = ($i % 2 )?><tr>
					                                                                
					<td class=""><?php echo ($vo["id"]); ?></td>
					<td class="" style="text-align:left;">&nbsp;&nbsp;<?php echo ($vo["name"]); ?></td>
					<td class=""><img src="__PUBLIC__/upload/certificate/small/<?php echo ($vo["image"]); ?>"  height="80" /></td>
					<td class=""><?php echo (toDate($vo["create_time"],"Y-m-d")); ?></td>			
					<td class=""><a href="__APP__/Company/editCertificate/id/<?php echo ($vo["id"]); ?>">修改</a> <a href="__APP__/Company/delCertificate/id/<?php echo ($vo["id"]); ?>">删除</a></td>
