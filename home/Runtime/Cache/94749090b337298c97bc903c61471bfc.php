...
.fendian_contact{ margin-top:20px; margin-left:20px;}
.fendian_contact li{
	border: 1px dashed #9F8571;
    float: left;
    margin-bottom: 10px;
    margin-right: 10px;
    padding: 5px;
...
<div class="container">
	...
	<div class="al_lf">
		...
		<div><img src="__PUBLIC__/images/zs_tit.jpg" /></div>	
			<div class="al_lf_c">
				<div class="cx_c" style="min-height:1068px;">
					<div class="jd_cont">
                    <?php echo ($companys["contact"]); ?>
						
					</div>
                    <p style="margin-left:18px; margin-top:30px; font-size:14px; font-weight:500;">总店地址：<?php echo ($coms["address"]); ?></p>
                   <p>
                   <div class="clear"></div>
                   <div class="fendian_contact">
                    <ul>
                    <?php if(is_array($comaddress1)): $i = 0; $__LIST__ = $comaddress1;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): ++$i;$mod = ($i % 2 )?><li>
                            	<p><?php echo ($vo["name"]); ?></br>
                                地址：<?php echo ($vo["address"]); ?> </br>
                                电话：<?php echo ($vo["tel"]); ?></p>
