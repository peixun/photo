...
<div class="container">
	...
	<div class="info_rt">
		...
		<div class="info_msg"><span class="i_msg2" style="float:right; width:65px;"> <a href="__APP__/Company/addNews">添加活动</a></span><span class="i_msg1"><b>活动列表</b></span></div>
		<div class="info_cont" style="min-height:300px;">
			<table border="0" cellpadding="0" cellspacing="0" class="info_tab" width="100%">
                ...
                <?php if(is_array($article)): $i = 0; $__LIST__ = $article;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): ++$i;$mod = ($i % 2 )?><tr>
					                                                                
					<td class=""><?php echo ($vo["id"]); ?></td>
					<td class="" style="text-align:left;">&nbsp;&nbsp;<?php echo ($vo["name_1"]); ?></td>
					<td class="" style="text-align:left;">&nbsp;&nbsp;<?php echo (getShequ($vo["cate_id"])); ?></td>
					<td class=""><?php echo (toDate($vo["create_time"],"Y-m-d")); ?> </td>			
					<td class=""><a href="__APP__/Company/editNews/id/<?php echo ($vo["id"]); ?>">修改</a> <a href="__APP__/Company/delNews/id/<?php echo ($vo["id"]); ?>">删除</a></td>
