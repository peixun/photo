...
<div class="container">
	...
	<div class="info_rt">
		...
		<div class="info_msg"><span class="i_msg2" style="float:right; width:100px;"> <a href="__APP__/Company/news">返回活动列表</a></span><span class="i_msg1"><b>添加活动信息</b></span></div>
		<div class="info_cont" style="min-height:300px;">
			<form action="__APP__/Company/insertNews" method="post" id="from2" name="form2" enctype="multipart/form-data">
<table  cellpadding="0" cellspacing="0" border="0" class="info_bd" width="100%">
  <tr>
    <td width="80" align="left">活动标题</td>
    <td><input type="text" name="name_1" class="bg_txt"  /></td>
  </tr>
  <tr>
    ...
    <td> <div id="uboxstyle"><select  name="cate_id" id="cate_id" class="bg_txt"  >
                  ...
                  <?php if(is_array($cate)): $i = 0; $__LIST__ = $cate;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$cate): ++$i;$mod = ($i % 2 )?><option   
                    value="<?php echo ($cate["id"]); ?>"><?php echo ($cate["name_1"]); ?>
   ...
   <tr>
    ...
    <td><input type="file" name="image"  class="bg_txt" /></td>
  </tr>
  <tr>
    <td  width="80" align="left">活动简介</td>
    <td><textarea name="brief_1" class="bg_textarea" ></textarea></td>
  </tr>
  <tr>
    <td  width="80" align="left">活动内容</td>
    <td><textarea id='content_1' name='content_1' style='width:620px;height:300px;visibility:hidden;' ></textarea></td>
  </tr>
 
  <tr>
    <td>&nbsp;</td>
    <td><input type="submit" value="添加" class="log_btn11" />&nbsp;<input type="reset" value="取消" class="log_btn11" /></td>
  </tr>
</table>
</form>
		</div>
