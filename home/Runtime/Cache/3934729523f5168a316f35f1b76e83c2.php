...
<div class="container">
	<div class="info_lf">
		...
		<div class="info_c">
            ...
            <p class="clk"><a href="__APP__/Member/myAnnounce">促销公告&nbsp;<?php echo getDayNewcout();?></a></p>
	...
	<div class="info_rt">
		<div class="info_rtit">
			<div class="inrt_n">促销公告</div>
			<div class="inrt_r">首页&nbsp;&nbsp; &gt; <a href="__APP__/Member">个人中心</a> &gt; <a href="javascript:void(0);" >促销公告</a></div>
		</div>
		...
		<div class="info_cont" style="min-height:300px;">
			<table border="0" cellpadding="0" cellspacing="0" class="info_tab" width="100%">
				<tr>
					...
					<td class="tit">阅读状态</td>
					<td class="tit">操作</td>
				</tr>
                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): ++$i;$mod = ($i % 2 )?><tr>
					                                                                
					<td class="" style="text-align:left;">&nbsp;&nbsp;<?php echo ($i); ?></td>
					<td class=""><a href="__APP__/Member/showAnnounce/id/<?php echo ($vo["id"]); ?>" ><?php echo ($vo["title"]); ?></a></td>
					
					<td class=""><?php echo (toDate($vo["create_time"],"Y-m-d")); ?> </td>
                    <td class=""><?php echo (getReadStatus($vo["id"])); ?> </td>
					
					<td class=""><a href="__APP__/Member/showAnnounce/id/<?php echo ($vo["id"]); ?>" >查看</a></td>
