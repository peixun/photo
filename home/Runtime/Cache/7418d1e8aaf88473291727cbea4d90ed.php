...
<div class="container">
	...
	<div class="al_lf">
		...
		<div class="al_lfcont">			
			...
			<div class="al_lf_c">
				<?php if(is_array($list)): $key = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): ++$key;$mod = ($key % 2 )?><div class="sjs_mod">
					<div class="sjs_m_lf"><a href="__APP__/BusinessChannel/designershow/id/<?php echo ($vo["uid"]); ?>_<?php echo ($vo["id"]); ?>.shtml"><?php if(($vo["image"])  ==  ""): ?><img src="__PUBLIC__/images/header2.jpg" /><?php else: ?><img src="__PUBLIC__/upload/designer/small/<?php echo ($vo["image"]); ?>" /><?php endif; ?></a></div>
					<div class="sjs_m_rt">
						<h3>设计师： <em><?php echo ($vo["name_1"]); ?></em></h3>
						<p>设计费：<?php echo ($vo["cost"]); ?></p>
						<p>擅长风格：<?php echo (utf_substr($vo["good_style"],20)); ?></p>
						<p>从业年限：<?php echo ($vo["work_years"]); ?></p>
					</div>
					<div class="sjs_m_det"><em>设计理念：</em><?php echo (utf_substr(strip_tags($vo["content_1"]),300)); ?></div>
					<div class="sjs_m_more"><a href="__APP__/BusinessChannel/designershow/id/<?php echo ($vo["uid"]); ?>_<?php echo ($vo["id"]); ?>.shtml"><img src="__PUBLIC__/images/ckdetail.jpg" /></a></div>
				</div>
                <div class="<?php if($key%2===0){ echo 'sjsclear'; } ?>"></div><?php endforeach; endif; else: echo "" ;endif; ?>
