...
<div class="container">
	...
	<div class="info_rt1">
		...
		<div class="info_main" style="overflow:hidden;">
        <div class="clear"></div>
        <form action="__APP__/Booking/BookInset" method="post" id="form">
		<div class="bm_left">
        	<div class="baoming_type" style="overflow:hidden;"><img src="__PUBLIC__/images/bm01.gif" /><p><input name="type" type="radio" value="1" <?php if(($type)  ==  "1"): ?>checked="checked"<?php endif; ?> />&nbsp;免费量房</p></div>
			...
			<table cellpadding="0" cellspacing="0" border="0" class="info_bd">
				<tr>
					...
					<td width="60%"><input type="text" class="bg_txt" name="mobile"  value="<?php echo ($user["mobile"]); ?>" id="mobile" /><span id="mobile_tips"></span></td>
				</tr>
                
				<tr>
					<td width="40%" align="right">您的称呼：</td>
					<td width="60%"><input type="text" class="bg_txt"  name="user_name" id="user_name" value="<?php echo ($user["user_name"]); ?>"/><span id="user_name_tips"></span></td>
				</tr>
				<tr>
					<td width="40%" align="right"></td>
					<td width="60%"> <input type="image" src="__PUBLIC__/images/bman.jpg" /></td>
				</tr>
			</table>
            </div>
            </form>
