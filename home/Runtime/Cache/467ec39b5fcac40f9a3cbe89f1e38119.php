...
<div class="container">
	<div class="info_lf">
		...
		<div class="info_c">
            ...
            <p class="clk" ><a href="__APP__/Member/myAttention">我的收藏</a></p>		
	...
	<div class="info_rt">
		<div class="info_rtit">
			<div class="inrt_n">我的收藏</div>
			<div class="inrt_r">首页&nbsp;&nbsp; &gt; <a href="__APP__/Member">个人中心</a> &gt; <a href="javascript:void(0);" >我的收藏</a></div>
		</div>
		...
		<div class="info_cont" style="min-height:300px;">
			<table border="0" cellpadding="0" cellspacing="0" class="info_tab" width="100%">
                ...
                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): ++$i;$mod = ($i % 2 )?><tr>
					...
					<td class="" style="text-align:left;">&nbsp;&nbsp;<?php echo (getAttentionName($vo["fid"],$vo['model'])); ?></td>
					<td class=""><?php echo (getAttentionType($vo["model"])); ?></td>
					
					<td class=""><?php echo (toDate($vo["create_time"],"Y-m-d")); ?> </td>
					
					<td class=""><a href="javascript:void(0);" onclick="delAttention(<?php echo ($vo["id"]); ?>);">取消</a></td>
