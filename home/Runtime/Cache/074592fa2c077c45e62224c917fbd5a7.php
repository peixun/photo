...
<div class="container">
	<div class="info_lf">
		...
		<div class="info_c">
			...
			<p class="clk"><a href="__APP__/Company/mycase">案例管理</a></p>
	...
	<div class="info_rt">
		<div class="info_rtit">
			<div class="inrt_n">案例管理</div>
			<div class="inrt_r">首页&nbsp;&nbsp; &gt; <a href="javascript:void(0);">个人中心</a> &gt; <a href="javascript:void(0);" >案例管理</a></div>
		</div>
		<div class="info_msg"><span class="i_msg2" style="float:right; width:65px;"> <a href="__APP__/Company/addCase">添加案例</a></span><span class="i_msg1"><b>案例列表</b></span></div>
		<div class="info_cont" style="min-height:300px;">
			<table border="0" cellpadding="0" cellspacing="0" class="info_tab" width="100%">
				<tr>
					<td class="tit">序号</td>                                                            
					<td class="tit">案例名称</td>
                    <td class="tit">风格</td>
                    <td class="tit">价格</td>
					<td class="tit">发布时间</td>			
					<td class="tit">操作</td>
				</tr>
                <?php if(is_array($case)): $i = 0; $__LIST__ = $case;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): ++$i;$mod = ($i % 2 )?><tr>
					                                                                
					<td class=""><?php echo ($vo["id"]); ?></td>
					<td class="" style="text-align:left;">&nbsp;&nbsp;<a href="__APP__/BusinessChannel/caseshow/id/<?php echo ($vo["uid"]); ?>_<?php echo ($vo["id"]); ?>.shtml" target="_blank"><?php echo ($vo["name_1"]); ?></a></td>
					<td class=""><?php echo ($vo["styles"]); ?></td>
					<td class=""><?php echo ($vo["budget"]); ?> </td>		
                    <td class=""><?php echo (toDate($vo["create_time"],"Y-m-d")); ?> </td>		
					<td class=""><a href="__APP__/Company/editCase/id/<?php echo ($vo["id"]); ?>">修改</a> <a href="__APP__/Company/delCase/id/<?php echo ($vo["id"]); ?>">删除</a></td>
