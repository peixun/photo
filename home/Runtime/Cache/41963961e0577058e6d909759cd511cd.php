...
<div class="container">
	...
	<div class="hotqlist" style="margin-top:8px;"><a href="__APP__/Shequ"><img src="__PUBLIC__/images/in_more.jpg" /></a></div>	
        	<div class="seach_show" style="margin-top:10px; margin-bottom:10px; margin-left:0;"><?php if(($searchshow)  ==  "1"): ?>下面是您搜索的内容：<span><?php echo ($keyword); ?></span><?php endif; ?> <?php if(($searchshow)  ==  "2"): ?>没有找<span><?php echo ($keyword); ?></span>相关的内容<?php endif; ?></div>
				<?php if(!empty($shequList)){ ?>
                <?php if(is_array($shequList)): $i = 0; $__LIST__ = $shequList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$top): ++$i;$mod = ($i % 2 )?><div class="sq_model" >
				<a href="__APP__/Shequ/<?php echo ($top["id"]); ?>.shtml"><img src="__PUBLIC__/upload/shequ/m_<?php echo (getCatePic($top["id"])); ?>" /></a>
				<p><a href="__APP__/Shequ/<?php echo ($top["id"]); ?>.shtml"><?php echo ($top["name_1"]); ?></a></p>
				<p>本社区共有<em><?php echo (getCaseCount($top["id"])); ?></em>套案例</p>
...
if(hour < 6){document.write("凌晨好！")} 
		...
		<div class="rt_c" style="margin-bottom:0; ">
			<h1>促销活动</h1>
			<div class="sub_sq" style="height:205px;">
				<?php if(is_array($article)): $art = 0; $__LIST__ = $article;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$article): ++$art;$mod = ($art % 2 )?><p <?php if(($art)  ==  "9"): ?>style="border-bottom:none;"<?php endif; ?>><a href="__APP__/News/<?php echo ($article["id"]); ?>.shtml"><?php echo (utf_substr($article["name_1"],28)); ?></a></p><?php endforeach; endif; else: echo "" ;endif; ?>
