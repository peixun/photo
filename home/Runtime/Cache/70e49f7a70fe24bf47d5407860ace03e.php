...
body{
	font-size:12px;}
div.messages{width:45%; height:90px; padding:5pt;  margin:110px auto 160px; clear:both; padding:12px;border:2px solid #5e1c02;text-align:center;}
.STYLE1 {color:#ed4901; text-align:center; font-size:14px;}
.center{text-align:center}
.space{text-align:center; height:30px;}
...
<TABLE  cellpadding=0 cellspacing=0 style="width:100%" >
	<TR class="row" >
		<th class="tCenter space" ><span class="STYLE1"><?php echo ($msgTitle); ?></span></th>
	</TR>
	<?php if(isset($message)): ?><TR class="row">
		<TD align="center" class="space" style="color:#ed4901"><?php echo ($message); ?></TD>
	</TR><?php endif; ?>
	<?php if(isset($error)): ?><TR class="row">
		<TD  align="center" class="space" style="color:red"><?php echo ($error); ?></TD>
	</TR><?php endif; ?>
	<?php if(isset($closeWin)): ?><TR class="row">
		<TD  class="center" class="space"><div class="dd">系统将在 <span style="font-weight:bold;color:#ed4901"><?php echo ($waitSecond); ?></span> 秒后自动关闭，如果不想等待,直接点击 <A HREF="<?php echo ($jumpUrl); ?>"><span style="color:#ed4901 ;font-weight:800;">这里</span></A> 关闭</div></TD>
	</TR><?php endif; ?>
	<?php if(!isset($closeWin)): ?><TR class="row">
		<TD class="center" class="space"><div class="dd">系统将在 <span style="color:#red;font-weight:bold;color:#ed4901"><?php echo ($waitSecond); ?></span> 秒后自动跳转,如果不想等待,直接点击 <A HREF="<?php echo ($jumpUrl); ?>"><span style="color:#ed4901; font-weight:800;">这里</span></A> 跳转</div></TD>
	</TR><?php endif; ?>
