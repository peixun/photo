...
<div class="container">
	...
	<div class="al_lf">
		...
		<div class="al_lfcont">			
			...
			<div class="al_lf_c">
				<div class="gd_c">
					<table class="gd_tab" border="0" cellpadding="0" cellspacing="0" width="100%">
						<tr>
							<td class="tit" width="12%">所属地区</td>                                                   
							<td class="tit" width="28%">楼盘名称</td>
							<td class="tit" width="10%">房型</td>
							<td class="tit" width="10%">预算</td>
							<td class="tit" width="25%">可供参观时间</td>
							<td class="tit" width="15%">预约</td>
						</tr>
                         <?php if(is_array($construc)): $i = 0; $__LIST__ = $construc;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): ++$i;$mod = ($i % 2 )?><tr>
							<td width="12%"><?php echo ($vo["area"]); ?></td>                                        
							<td width="28%"><a name="<?php echo ($vo["name_1"]); ?>"></a><?php echo ($vo["name_1"]); ?></td>
							<td width="10%"><?php echo ($vo["root_unit"]); ?></td>
							<td width="10%"><?php echo ($vo["budget"]); ?> </td>
							<td width="25%"><?php echo (utf_substr($vo["visit_time"],10)); ?></td>
							<td width="15%"><a href="javascript:add_d(<?php echo ($vo["id"]); ?>,<?php echo ($comid); ?>);"><img src="__PUBLIC__/images/gd_yy.jpg" /></a></td>
