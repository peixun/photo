...
<html>
	...
	<body>
		<div class="main">
			...
			<form name="uploadForm" method="post" enctype="multipart/form-data" target="uploadIframe" action="<?php echo $_REQUEST['root'];?>/index.php">
				...
				<input type="hidden" name="m" value="FileUpload" />
				<input type="hidden" name="a" value="doUpload" />
				<ul class="table">
					<li>
