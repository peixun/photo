 ...
 * @copyright Copyright &copy; 2009-2010 eyoo Software LLC
 +----------------------------------------------------------
 */// 商品图库
class NewsGalleryAction extends CommonAction{
	...
	public function doBatch()
	{
	    ...
	    {
	    	//第一个
	    	$res = D("NewsGallery")->order("id asc")->limit(1)->find();  //查出第一第二个图库   	
	    }
	    else 
	    {
	    	$res = D("NewsGallery")->where("id>".$gallery_id)->order("id asc")->limit(1)->find();  //查出第一第二个图库
	    }
		if($res)
		{
