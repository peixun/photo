...
<input type="text" name="adm_name" title="<?php echo l('ADMIN_NAME');?>" class="medium" >
...
<div class="list" >
<!-- Think 系统列表组件开始 -->
<table id="checkList" class="list" cellpadding=0 cellspacing=0 ><tr><td height="5" colspan="10" class="topTd" ></td></tr><tr class="row" ><th width="8"><input type="checkbox" id="check" onclick="CheckAll('checkList')"></th><th width="8%"><a href="javascript:sortBy('id','<?php echo ($sort); ?>','index')" title="按照<?php echo (L("ID")); ?><?php echo ($sortType); ?> "><?php echo (L("ID")); ?><?php if(($order)  ==  "id"): ?><img src="__TMPL__ThemeFiles/Images/<?php echo ($sortImg); ?>.gif" width="12" height="17" border="0" align="absmiddle"><?php endif; ?></a></th><th><a href="javascript:sortBy('adm_name','<?php echo ($sort); ?>','index')" title="按照<?php echo (L("ADMIN_NAME")); ?><?php echo ($sortType); ?> "><?php echo (L("ADMIN_NAME")); ?><?php if(($order)  ==  "adm_name"): ?><img src="__TMPL__ThemeFiles/Images/<?php echo ($sortImg); ?>.gif" width="12" height="17" border="0" align="absmiddle"><?php endif; ?></a></th><th><a href="javascript:sortBy('id','<?php echo ($sort); ?>','index')" title="按照管理员分组<?php echo ($sortType); ?> ">管理员分组<?php if(($order)  ==  "id"): ?><img src="__TMPL__ThemeFiles/Images/<?php echo ($sortImg); ?>.gif" width="12" height="17" border="0" align="absmiddle"><?php endif; ?></a></th><th><a href="javascript:sortBy('last_time','<?php echo ($sort); ?>','index')" title="按照<?php echo (L("LAST_TIME")); ?><?php echo ($sortType); ?> "><?php echo (L("LAST_TIME")); ?><?php if(($order)  ==  "last_time"): ?><img src="__TMPL__ThemeFiles/Images/<?php echo ($sortImg); ?>.gif" width="12" height="17" border="0" align="absmiddle"><?php endif; ?></a></th><th><a href="javascript:sortBy('login_count','<?php echo ($sort); ?>','index')" title="按照<?php echo (L("LOGIN_COUNT")); ?><?php echo ($sortType); ?> "><?php echo (L("LOGIN_COUNT")); ?><?php if(($order)  ==  "login_count"): ?><img src="__TMPL__ThemeFiles/Images/<?php echo ($sortImg); ?>.gif" width="12" height="17" border="0" align="absmiddle"><?php endif; ?></a></th><th><a href="javascript:sortBy('create_time','<?php echo ($sort); ?>','index')" title="按照<?php echo (L("CREATE_TIME")); ?><?php echo ($sortType); ?> "><?php echo (L("CREATE_TIME")); ?><?php if(($order)  ==  "create_time"): ?><img src="__TMPL__ThemeFiles/Images/<?php echo ($sortImg); ?>.gif" width="12" height="17" border="0" align="absmiddle"><?php endif; ?></a></th><th><a href="javascript:sortBy('update_time','<?php echo ($sort); ?>','index')" title="按照<?php echo (L("UPDATE_TIME")); ?><?php echo ($sortType); ?> "><?php echo (L("UPDATE_TIME")); ?><?php if(($order)  ==  "update_time"): ?><img src="__TMPL__ThemeFiles/Images/<?php echo ($sortImg); ?>.gif" width="12" height="17" border="0" align="absmiddle"><?php endif; ?></a></th><th><a href="javascript:sortBy('last_ip','<?php echo ($sort); ?>','index')" title="按照<?php echo (L("LAST_IP")); ?><?php echo ($sortType); ?> "><?php echo (L("LAST_IP")); ?><?php if(($order)  ==  "last_ip"): ?><img src="__TMPL__ThemeFiles/Images/<?php echo ($sortImg); ?>.gif" width="12" height="17" border="0" align="absmiddle"><?php endif; ?></a></th><th >操作</th></tr><?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$adm): ++$i;$mod = ($i % 2 )?><tr class="row" onmouseover="over(event)" onmouseout="out(event)" onclick="change(event)" ><td><?php if(($adm['level'] == '0')or($adm['level'] > 0)): ?><?php else: ?><input type="checkbox" class="key" name="key"	value="<?php echo ($adm["id"]); ?>" <?php if($adm['checked']): ?>checked="checked"<?php endif; ?> ><?php endif; ?></td><td><?php echo ($adm["id"]); ?></td><td><a href="javascript:edit('<?php echo (addslashes($adm["id"])); ?>')"><?php echo ($adm["adm_name"]); ?></a></td><td><?php echo (get_role_name($adm["id"])); ?></td><td><?php echo (toDate($adm["last_time"])); ?></td><td><?php echo ($adm["login_count"]); ?></td><td><?php echo (toDate($adm["create_time"])); ?></td><td><?php echo (toDate($adm["update_time"])); ?></td><td><?php echo ($adm["last_ip"]); ?></td><td> <?php echo (showStatus($adm["status"],$adm['id'])); ?>&nbsp;<a href="javascript:edit('<?php echo ($adm["id"]); ?>')"><?php echo (L("_EDIT_DATA")); ?></a>&nbsp;<a href="javascript:foreverdel('<?php echo ($adm["id"]); ?>')"><?php echo (L("_DELETE_DATA")); ?></a>&nbsp;</td></tr><?php endforeach; endif; else: echo "" ;endif; ?><tr><td height="5" colspan="10" class="bottomTd"></td></tr></table>
<!-- Think 系统列表组件结束 -->
