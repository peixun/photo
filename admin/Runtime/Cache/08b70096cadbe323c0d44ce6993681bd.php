...
<table cellpadding="0" cellspacing="0" width=100%>
	<tr>
		...
		<tr>
			...
			<td class="tLeft" >
				<div  style='margin-bottom:5px; '><input type='text' name='name_1' id='_1' class='bLeftRequire' value=' 为孩子而用心装饰的' /> </div>
			</td>
		</tr>
        <tr>
    ...
    <select name="cate_id" class="bLeftRequire">
		...
		<tr>
			...
			<td class="tLeft" >
				<input type='text' name='sort' id='' class='bLeft' value='1'  />
			</td>
		</tr>
	...
	<td class="tLeft" >
		...
		<tr>
			...
			<td class="tLeft" >
				<textarea name='brief_1' id='' class='bLeft' rows='' cols='' style='width:650px;height:200px;' >家有幼儿的居家空间，最怕孩子跑来跑去撞到沙发、踢到柜子而受伤，如果因此而限制孩子的行动，家反而成为他们不喜欢的地方。所以设计师在规划空间时，从玄关、客厅、厨房到餐厅都采用开放式，仅运用颜色来区隔空间，从玄关的黄到客厅的线到厨房的白，每个空间都有自己的个性。考虑到预算，舍弃木作，以现成家具为主，以活动式的收纳方便孩子在空间活动。

　　从玄关到客厅的全部收纳都由家具解决，包含玄关的中高鞋柜、可作为穿鞋的矮柜，旁边的展示柜也可以作为鞋及其他杂物的收纳柜，而客厅则以白色电视柜及原木造型格子来收纳音响、视听等</textarea>
			</td>
		</tr>
		<tr>
			<td class="tRight" width="80"><?php echo (L("ARTICLE_CONTENT")); ?>：</td>
			<td class="tLeft" >
            <script type='text/javascript'>KE.show({id : 'content_1',cssPath : '__TMPL__ThemeFiles/Css/style.css',skinType: 'tinymce',allowFileManager : true});</script><div  style='margin-bottom:5px;widht:100% '><textarea id='content_1' name='content_1' style='width:700px;height:400px;visibility:hidden;' >家有幼儿的居家空间，最怕孩子跑来跑去撞到沙发、踢到柜子而受伤，如果因此而限制孩子的行动，家反而成为他们不喜欢的地方。所以设计师在规划空间时，从玄关、客厅、厨房到餐厅都采用开放式，仅运用颜色来区隔空间，从玄关的黄到客厅的线到厨房的白，每个空间都有自己的个性。考虑到预算，舍弃木作，以现成家具为主，以活动式的收纳方便孩子在空间活动。<p align="center"><img alt="" src="http://sh.tobosu.com/UserImages/company/editUploadfile/20120912/20120912171844_3405.jpg" /></p>
