...
时间：<input type="text" class="bLeft" id="sendTime" value="<?php echo toDate(gmtTime());?>" /> -->
...
<div class="list" >
<!-- Think 系统列表组件开始 -->
<table id="checkList" class="list" cellpadding=0 cellspacing=0 ><tr><td height="5" colspan="6" class="topTd" ></td></tr><tr class="row" ><th width="8"><input type="checkbox" id="check" onclick="CheckAll('checkList')"></th><th width="40"><a href="javascript:sortBy('id','<?php echo ($sort); ?>','index')" title="按照编号<?php echo ($sortType); ?> ">编号<?php if(($order)  ==  "id"): ?><img src="__TMPL__ThemeFiles/Images/<?php echo ($sortImg); ?>.gif" width="12" height="17" border="0" align="absmiddle"><?php endif; ?></a></th><th><a href="javascript:sortBy('case_id','<?php echo ($sort); ?>','index')" title="按照案例名称<?php echo ($sortType); ?> ">案例名称<?php if(($order)  ==  "case_id"): ?><img src="__TMPL__ThemeFiles/Images/<?php echo ($sortImg); ?>.gif" width="12" height="17" border="0" align="absmiddle"><?php endif; ?></a></th><th><a href="javascript:sortBy('content','<?php echo ($sort); ?>','index')" title="按照评论内容<?php echo ($sortType); ?> ">评论内容<?php if(($order)  ==  "content"): ?><img src="__TMPL__ThemeFiles/Images/<?php echo ($sortImg); ?>.gif" width="12" height="17" border="0" align="absmiddle"><?php endif; ?></a></th><th><a href="javascript:sortBy('uid','<?php echo ($sort); ?>','index')" title="按照评论作者<?php echo ($sortType); ?> ">评论作者<?php if(($order)  ==  "uid"): ?><img src="__TMPL__ThemeFiles/Images/<?php echo ($sortImg); ?>.gif" width="12" height="17" border="0" align="absmiddle"><?php endif; ?></a></th><th >操作</th></tr><?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$Commend): ++$i;$mod = ($i % 2 )?><tr class="row" onmouseover="over(event)" onmouseout="out(event)" onclick="change(event)" ><td><?php if(($Commend['level'] == '0')or($Commend['level'] > 0)): ?><?php else: ?><input type="checkbox" class="key" name="key"	value="<?php echo ($Commend["id"]); ?>" <?php if($Commend['checked']): ?>checked="checked"<?php endif; ?> ><?php endif; ?></td><td><?php echo ($Commend["id"]); ?></td><td><?php echo (getCaseName($Commend["case_id"])); ?></td><td><?php echo ($Commend["content"]); ?></td><td><?php echo (getUserName($Commend["uid"])); ?></td><td><a href="javascript:foreverdel('<?php echo ($Commend["id"]); ?>')"><?php echo (L("_DELETE_DATA")); ?></a>&nbsp;</td></tr><?php endforeach; endif; else: echo "" ;endif; ?><tr><td height="5" colspan="6" class="bottomTd"></td></tr></table>
<!-- Think 系统列表组件结束 -->
