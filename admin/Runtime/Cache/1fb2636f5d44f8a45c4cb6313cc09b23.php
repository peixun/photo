...
<input type="text" name="name" title="项目名称" class="medium" >
...
<input type="hidden" name="<?php echo c('VAR_MODULE');?>" value="Construction" />
...
<div class="list" >
<!-- Think 系统列表组件开始 -->
<table id="checkList" class="list" cellpadding=0 cellspacing=0 ><tr><td height="5" colspan="9" class="topTd" ></td></tr><tr class="row" ><th width="8"><input type="checkbox" id="check" onclick="CheckAll('checkList')"></th><th width="8%"><a href="javascript:sortBy('id','<?php echo ($sort); ?>','index')" title="按照<?php echo (L("ID")); ?><?php echo ($sortType); ?> "><?php echo (L("ID")); ?><?php if(($order)  ==  "id"): ?><img src="__TMPL__ThemeFiles/Images/<?php echo ($sortImg); ?>.gif" width="12" height="17" border="0" align="absmiddle"><?php endif; ?></a></th><th><a href="javascript:sortBy('area','<?php echo ($sort); ?>','index')" title="按照所在地区<?php echo ($sortType); ?> ">所在地区<?php if(($order)  ==  "area"): ?><img src="__TMPL__ThemeFiles/Images/<?php echo ($sortImg); ?>.gif" width="12" height="17" border="0" align="absmiddle"><?php endif; ?></a></th><th><a href="javascript:sortBy('name_1','<?php echo ($sort); ?>','index')" title="按照项目名称<?php echo ($sortType); ?> ">项目名称<?php if(($order)  ==  "name_1"): ?><img src="__TMPL__ThemeFiles/Images/<?php echo ($sortImg); ?>.gif" width="12" height="17" border="0" align="absmiddle"><?php endif; ?></a></th><th><a href="javascript:sortBy('root_unit','<?php echo ($sort); ?>','index')" title="按照房型<?php echo ($sortType); ?> ">房型<?php if(($order)  ==  "root_unit"): ?><img src="__TMPL__ThemeFiles/Images/<?php echo ($sortImg); ?>.gif" width="12" height="17" border="0" align="absmiddle"><?php endif; ?></a></th><th><a href="javascript:sortBy('budget','<?php echo ($sort); ?>','index')" title="按照预算<?php echo ($sortType); ?> ">预算<?php if(($order)  ==  "budget"): ?><img src="__TMPL__ThemeFiles/Images/<?php echo ($sortImg); ?>.gif" width="12" height="17" border="0" align="absmiddle"><?php endif; ?></a></th><th><a href="javascript:sortBy('uid','<?php echo ($sort); ?>','index')" title="按照公司名称<?php echo ($sortType); ?> ">公司名称<?php if(($order)  ==  "uid"): ?><img src="__TMPL__ThemeFiles/Images/<?php echo ($sortImg); ?>.gif" width="12" height="17" border="0" align="absmiddle"><?php endif; ?></a></th><th><a href="javascript:sortBy('visit_time','<?php echo ($sort); ?>','index')" title="按照参观时间<?php echo ($sortType); ?> ">参观时间<?php if(($order)  ==  "visit_time"): ?><img src="__TMPL__ThemeFiles/Images/<?php echo ($sortImg); ?>.gif" width="12" height="17" border="0" align="absmiddle"><?php endif; ?></a></th><th >操作</th></tr><?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$Article): ++$i;$mod = ($i % 2 )?><tr class="row" onmouseover="over(event)" onmouseout="out(event)" onclick="change(event)" ><td><?php if(($Article['level'] == '0')or($Article['level'] > 0)): ?><?php else: ?><input type="checkbox" class="key" name="key"	value="<?php echo ($Article["id"]); ?>" <?php if($Article['checked']): ?>checked="checked"<?php endif; ?> ><?php endif; ?></td><td><?php echo ($Article["id"]); ?></td><td><?php echo ($Article["area"]); ?></td><td><a href="javascript:edit('<?php echo (addslashes($Article["id"])); ?>')"><?php echo ($Article["name_1"]); ?></a></td><td><?php echo ($Article["root_unit"]); ?></td><td><?php echo ($Article["budget"]); ?></td><td><?php echo (getCompany($Article["uid"])); ?></td><td><?php echo ($Article["visit_time"]); ?></td><td><a href="javascript:edit('<?php echo ($Article["id"]); ?>')"><?php echo (L("_EDIT_DATA")); ?></a>&nbsp;<a href="javascript:foreverdel('<?php echo ($Article["id"]); ?>')"><?php echo (L("_DELETE_DATA")); ?></a>&nbsp;</td></tr><?php endforeach; endif; else: echo "" ;endif; ?><tr><td height="5" colspan="9" class="bottomTd"></td></tr></table>
<!-- Think 系统列表组件结束 -->
