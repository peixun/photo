...
<div class="fLeft"><span id="key"><input type="text" name="name" title="<?php echo (L("LINK_NAME")); ?>" class="medium" ></span></div>
...
<div class="list" >
<!-- Think 系统列表组件开始 -->
<table id="checkList" class="list" cellpadding=0 cellspacing=0 ><tr><td height="5" colspan="6" class="topTd" ></td></tr><tr class="row" ><th width="8"><input type="checkbox" id="check" onclick="CheckAll('checkList')"></th><th width="8%"><a href="javascript:sortBy('id','<?php echo ($sort); ?>','index')" title="按照<?php echo (L("ID")); ?><?php echo ($sortType); ?> "><?php echo (L("ID")); ?><?php if(($order)  ==  "id"): ?><img src="__TMPL__ThemeFiles/Images/<?php echo ($sortImg); ?>.gif" width="12" height="17" border="0" align="absmiddle"><?php endif; ?></a></th><th><a href="javascript:sortBy('name_1','<?php echo ($sort); ?>','index')" title="按照<?php echo (L("LINK_NAME")); ?><?php echo ($sortType); ?> "><?php echo (L("LINK_NAME")); ?><?php if(($order)  ==  "name_1"): ?><img src="__TMPL__ThemeFiles/Images/<?php echo ($sortImg); ?>.gif" width="12" height="17" border="0" align="absmiddle"><?php endif; ?></a></th><th><a href="javascript:sortBy('url','<?php echo ($sort); ?>','index')" title="按照<?php echo (L("LINK_URL")); ?><?php echo ($sortType); ?> "><?php echo (L("LINK_URL")); ?><?php if(($order)  ==  "url"): ?><img src="__TMPL__ThemeFiles/Images/<?php echo ($sortImg); ?>.gif" width="12" height="17" border="0" align="absmiddle"><?php endif; ?></a></th><th><a href="javascript:sortBy('sort','<?php echo ($sort); ?>','index')" title="按照<?php echo (L("SORT")); ?><?php echo ($sortType); ?> "><?php echo (L("SORT")); ?><?php if(($order)  ==  "sort"): ?><img src="__TMPL__ThemeFiles/Images/<?php echo ($sortImg); ?>.gif" width="12" height="17" border="0" align="absmiddle"><?php endif; ?></a></th><th >操作</th></tr><?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$link): ++$i;$mod = ($i % 2 )?><tr class="row" onmouseover="over(event)" onmouseout="out(event)" onclick="change(event)" ><td><?php if(($link['level'] == '0')or($link['level'] > 0)): ?><?php else: ?><input type="checkbox" class="key" name="key"	value="<?php echo ($link["id"]); ?>" <?php if($link['checked']): ?>checked="checked"<?php endif; ?> ><?php endif; ?></td><td><?php echo ($link["id"]); ?></td><td><a href="javascript:edit('<?php echo (addslashes($link["id"])); ?>')"><?php echo ($link["name_1"]); ?></a></td><td><?php echo ($link["url"]); ?></td><td><?php echo (getSort($link["sort"],$link['id'])); ?></td><td> <?php echo (showStatus($link["status"],$link['id'])); ?>&nbsp;<a href="javascript:edit('<?php echo ($link["id"]); ?>')"><?php echo (L("_EDIT_DATA")); ?></a>&nbsp;<a href="javascript:foreverdel('<?php echo ($link["id"]); ?>')"><?php echo (L("_DELETE_DATA")); ?></a>&nbsp;</td></tr><?php endforeach; endif; else: echo "" ;endif; ?><tr><td height="5" colspan="6" class="bottomTd"></td></tr></table>
<!-- Think 系统列表组件结束 -->
