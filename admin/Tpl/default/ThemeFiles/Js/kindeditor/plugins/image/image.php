...
<html>
	...
	<body>
		<div class="main">
			...
			<form name="uploadForm" method="post" enctype="multipart/form-data" target="uploadIframe" action="<?php echo $_REQUEST['root'];?>/<?php echo $_REQUEST['admin_file'];?>">
				...
				<input type="hidden" name="<?php echo $_REQUEST['var_module'];?>" value="FileUpload" />
				<input type="hidden" name="<?php echo $_REQUEST['var_action'];?>" value="doUpload" />
				<ul class="table">
					<li>
